            ...
            <div class="sub-container">
                ...
                <div class="card">
                    <div class="card-container">
                        ...
                        <div class="input-group">
                            ...
                            <input name="amount" class="range-inputs" type="range" id="amount" min="1000" max="600000" value="1000">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input name="months" class="range-inputs" type="range" id="months" min="1" max="120" value="1">
                        </div>
                ...
                <div class="">
                    ...
                    <div class="validation-div">
                        ...
                        <button type="submit" name="action" class="validate-btn">Validate</button>
                    </div>
